...
//NOTE: I tried going the extra mile to display the results on the webpage!
//This is as far as I was able to go with my current knowledge!
// Display results on the webpage
const table = document.getElementById('groceryTable');

// Function to render items in the table
function renderItemsInTable(items) {
...
// Render items in the table initially
